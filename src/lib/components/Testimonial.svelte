...
<div class={classNames(firstEntry ? ' sm:pb-12 py-40' : 'py-8 sm:py-12')} style={`background: url(${testimonial.image}) center center no-repeat; background-size: cover;`}>
  <div class="max-w-screen-md mx-auto px-6 flex space-x-6 sm:space-x-8 relative">
    <div class="flex-shrink-0 w-14 h-auto sm:w-20  overflow-hidden relative">
      {#if $isEditing}
      <Image
        class=""
        maxWidth={1920}
